...
<div class="">
    ...
    <div class="text-center mb-3">
        <img width="160"
             src="{{ asset('public/assets/brand/cabtale-logo.png') }}"
             alt="{{$businessName}}">
    </div>
                ...
                <tr>
                    <td class="text-start">
                        <table style="vertical-align:middle">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{asset('public/assets/admin-module/img/media/from.png')}}"
                                         alt="">
                                </td>
                                <td>
                        ...
                        <table style="vertical-align:middle; margin-top: 10px">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{asset('public/assets/admin-module/img/media/to.png')}}"
                                         alt="">
                                </td>
                                <td>
                                    <div class="d-inline-block ml-3 media-body">
